...
if($action == 'base') {
	...
	if($method == 'GET') {
		...
		$input['sitekeywords'] = form_text('sitekeywords', isset($conf['sitekeywords']) ? $conf['sitekeywords'] : '');
		...
		$sitekeywords = param('sitekeywords', ''); // 首页 meta keywords，纯文本逗号分隔
		...
		$replace['sitekeywords'] = $sitekeywords;
